...
export default function CategoriesPage() {
  ...
  const tableColumnCount = canManageCategories ? 3 : 2

  return (
    <ManagementPageLayout
      title="Kategori"
      description="Kelompokkan produk agar mudah dicari dan dikelola."
      addLabel={canManageCategories ? "Tambah kategori" : undefined}
      searchValue={search}
      searchPlaceholder="Cari nama atau deskripsi..."
      message={message}
      error={error}
      onAdd={canManageCategories ? openCreateForm : undefined}
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              {canManageCategories && <TableHead className="w-28 text-right">Aksi</TableHead>}
            </TableRow>
          </TableHeader>
          <TableBody>
